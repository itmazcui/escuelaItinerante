    ...
    public class PagoController : Controller
    {
        ...
        private string EnviarRecibosPorMail(string html, Alumno alumno)
        {
            try
            {
                ...
                email.Subject = "Comprobante Escuela - " + alumno.Nombre + " " + alumno.Apellido;
                email.Body = html;
                ...
                return "El comprobantes se ha enviado";
            }
            catch (Exception ex)
            {
        ...
        public ActionResult PagoParcial(int idAlumno, int idComision, int idClase, int montoAbonado)
        {
            ...
            var pagoexitoso = _alumnoLogic.SetPagoParcial(pagoDTO);
